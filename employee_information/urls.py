...
urlpatterns = [
    ...
    path('manage_tools', views.manage_tools, name="manage_tools-page"),
    path('save_tools', views.save_tools, name="save-tools-page"),
    path('delete_tools', views.delete_tools, name="delete-tools"),
